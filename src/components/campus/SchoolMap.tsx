...
const DynamicSchoolMap = dynamic(() => import('./SchoolMapClient'), {
  ssr: false,
  loading: () => (
    <div className="h-full min-h-[220px] w-full rounded-2xl bg-surface-secondary flex flex-col items-center justify-center border border-border gap-2 text-text-tertiary">
